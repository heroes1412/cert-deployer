...
set GOOS=windows
set GOARCH=amd64
go build -o ..\build\windows\cert-server.exe main.go
if %errorlevel% neq 0 (
...
set GOOS=linux
set GOARCH=amd64
go build -o ..\build\linux\cert-server main.go
if %errorlevel% neq 0 (
...
set GOOS=windows
set GOARCH=amd64
go build -o ..\build\windows\cert-agent.exe main.go
if %errorlevel% neq 0 (
...
set GOOS=linux
set GOARCH=amd64
go build -o ..\build\linux\cert-agent main.go
if %errorlevel% neq 0 (
